...
for fiberlengthPANDAinitial in np.arange(0.0, 0.7, 0.05):

    for fiberlength in np.arange(1.1, 1.8, 0.05):
        ...
        gainPANDA   = 0.0 # dB/m
        fiberlengthPANDA = 2.0
        #fiberlengthPANDAinitial = 0.1
        ...
        np.savetxt('.\\Fiber Length Optimization Output\\Z_SMF' + str(fiberlengthPANDAinitial) + 'EDF' + str(fiberlength) + '.csv', Z[preSMF:], delimiter=',')
        np.savetxt('.\\Fiber Length Optimization Output\\LIT_SMF' + str(fiberlengthPANDAinitial) + 'EDF' + str(fiberlength) + '.csv', lIT[preSMF:,:], delimiter=',')
